...
<div class="my-4 p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
    <div class="flex gap-3">
        ...
        <p class="text-sm text-amber-700 dark:text-amber-300">{{ $text }}</p>
    </div>
</div>
